...
size: .word  12             # size of "array" 
      ...
      la   $a0, tail        # load address of print heading
      li   $v0, 4           # specify Print String service
      syscall  
      li   $v0, 5           # specify Print String service
      syscall
      
      add  $t5,$zero, $v0      # load array size
...
tail: .asciiz  "How many Fibonacci number do you want:\n"
      .text
